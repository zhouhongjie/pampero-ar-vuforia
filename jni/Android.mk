...
LOCAL_SRC_FILES = ../../../Android/vuforia-sdk-android-1-5-9/build/lib/$(TARGET_ARCH_ABI)/libQCAR.so
LOCAL_EXPORT_C_INCLUDES := $(LOCAL_PATH)/../../../Android/vuforia-sdk-android-1-5-9/build/include
...
LOCAL_SRC_FILES := Pampero.cpp PamperoUtils.cpp
